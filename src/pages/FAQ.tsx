...
const faqs = [
  { q: "Is ExamDrill NG free to use?", a: "Yes! The free plan gives you 20 questions per day and 3 mock exams per month. Premium plans unlock unlimited access, full explanations, and analytics." },
  { q: "Which exams does ExamDrill cover?", a: "We focus exclusively on UTME (JAMB), WAEC, and NECO — the three most important exams for Nigerian secondary school students." },
  ...
  { q: "Can I use ExamDrill on my phone?", a: "Absolutely. ExamDrill is built mobile-first. It works smoothly on any phone browser — no app download needed." },
  ...
  { q: "How do I contact support?", a: "Email us at support@examdrillng.com or use the contact form on our Contact page. We typically respond within 24 hours." },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container max-w-2xl py-16">
        ...
        <p className="mb-10 text-muted-foreground">Everything you need to know about ExamDrill NG.</p>
